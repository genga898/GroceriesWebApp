<%@ Page Title="" Language="C#" MasterPageFile="../Users/grocery.Master" AutoEventWireup="true" CodeBehind="freshjuice.aspx.cs" Inherits="GroceriesWebApp.freshjuice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <p class="text-center display-6">Fresh Juice</p>
    </div>
    <div class="container-fluid py-3 gap-0 d-flex flex-sm-wrap flex-lg-row">
        <asp:Repeater ID="rpFreshJuice" runat="server" >
            <ItemTemplate>
                <div class="col-sm-4 col-md-4 col-lg-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><asp:Literal runat="server" ID="litProductDescription" Text="Fresh Juice" /></p>
                            <div class="row">
                                <div class="col-6">
