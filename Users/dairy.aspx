<%@ Page Title="" Language="C#" MasterPageFile="../Users/grocery.Master" AutoEventWireup="true" CodeBehind="dairy.aspx.cs" Inherits="GroceriesWebApp.dairy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <p class="text-center display-6"> Dairy Products</p>
    </div>
                ...
                <div class="col-sm-4 col-md-4 col-lg-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><asp:Literal runat="server" ID="litProductDescription" Text="Dairy"/></p>
                            <div class="row">
                                <div class="col-6">
